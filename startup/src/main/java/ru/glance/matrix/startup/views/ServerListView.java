package ru.glance.matrix.startup.views;
...
public class ServerListView implements PopupWindowInterface {
    ...
    private TableView createTable() {
        ...
        action.setCellFactory(new Callback<TableColumn<ServerConnectionAddress, String>, TableCell<ServerConnectionAddress, String>>() {
            @Override
